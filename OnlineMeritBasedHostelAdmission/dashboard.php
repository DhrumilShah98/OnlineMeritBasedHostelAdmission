									...
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-success text-light">
												...
												<div class="stat-panel-number h1 ">My Hostel</div>
									...
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-success text-light">
												...
												<div class="stat-panel-number h1 ">Round 1</div>
													
												</div>
											</div>
											<a href="book-hostel.php" class="block-anchor panel-footer text-center">Apply &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
								</div>
							</div>
