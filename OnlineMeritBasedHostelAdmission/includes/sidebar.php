<nav class="ts-sidebar">
		<ul class="ts-sidebar-menu">
				...
				{ ?>
					...
					<!-- <li><a href="book-hostel.php"><i class="fa fa-file-o"></i>Apply For Hostel</a></li> -->
					<li><a href="room-details.php"><i class="fa fa-file-o"></i>Hostel Details</a></li>
				...
				<?php } else { ?>
					...
					<li><a href="viewseats.php"><i class="fa fa-user"></i> View Vacant Seats</a></li>
