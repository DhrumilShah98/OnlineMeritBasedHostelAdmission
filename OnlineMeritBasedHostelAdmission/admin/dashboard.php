			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title" style="padding-top: 20px;">Dashboard</h2>
...
<?php
$result ="SELECT count(*) FROM user_reg ";
									...
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-success text-light">
												<div class="stat-panel text-center">
<?php
$result1 ="SELECT count(*) FROM hostel ";
...
?>												
													...
													<div class="stat-panel-title text-uppercase">Total Hostel </div>
												</div>
											</div>
									...
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-info text-light">
												<div class="stat-panel text-center">
<?php
$result2 ="SELECT count(*) FROM college ";
...
?>												
													...
													<div class="stat-panel-title text-uppercase">Total College</div>
												</div>
											</div>
					...
					<button class="btn btn-primary"><a href="final_admission_file.php">Withdraw Result</a></button>						
